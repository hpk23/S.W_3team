...
int TcpClientSocket::getFileSize(char* file_name)
{
	FILE *file;
...
void TcpClientSocket::resumeFile(string f_name)
{
...
vector<string> TcpClientSocket::getCorruptedFileList()
{
	return corrupted_file_list;
}

void TcpClientSocket::clearCorruptedFileList()
{
